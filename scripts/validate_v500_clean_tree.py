...
REQUIRED=[
 'docs/V5_0_RC2_NOTES.md','tests/test_v500_capability_layer.py','scripts/validate_v500_integrated.py','scripts/validate_v500_clean_tree.py','run-v500-validation.ps1',
 ...
 'src/iras/v5/coding_workspace.py','src/iras/v5/capability_learning.py','src/iras/v5/connectors.py','src/iras/v5/artifacts.py','src/iras/v5/sandbox.py',
 'src/iras/v5/skills.py','src/iras/v5/encrypted_sync.py','src/iras/v5/goals.py','src/iras/tools/v5.py','clients/web/index.html'
]
SECRET_PATTERNS=[
...
def main():
    ...
    print('=== IRAS v5.0 RC2 CLEAN TREE VALIDATION ===')
