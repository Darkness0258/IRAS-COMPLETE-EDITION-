...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build deterministic IRAS v5.0.0 RC4 source release ZIP")
    parser.add_argument("output", nargs="?", default=str(ROOT.parent / "IRAS-v5.0.0-RC4-COMPLETE-ALL-FEATURES.zip"))
