...
def main() -> None:
    ...
    assert observation.get("vision_requested", "off") == "off"

    print("SYSTEM INFO AVAILABLE:", bool(info))
    print("COMPUTER STATUS AVAILABLE:", bool(status))
    ...
    print("VISION REQUESTED:", observation.get("vision_requested") != "off")
    print("OMNIPARSER AUTOSTART EXECUTED:", False)
